...
def execute_paginated_query(query, page: int = 1, page_size: int = 10, 
                           log_action: str = None) -> Tuple[List[Dict[str, Any]], int]:
    """
    ...
    try:
        ...
        if log_action:
            log_operation(
                ...
                {"page": page, "page_size": page_size, "total": total_count, "returned": len(data)}
            )
...
def optimize_query_execution(session, query, operation_name: str = "query generica") -> Any:
    """
